...
abstract class Aapt2MavenUtilsHelper {
    ...
    static String get_AAPT2_CONFIG_NAME() {
        try {
            ...
            return AAPT2_CONFIG_NAME
        } catch (Exception e) {
            throw new RuntimeException("Cannot access field 'Aapt2MavenUtils.AAPT2_CONFIG_NAME'", e)
        }
    }
    ...
    static {
        try {
            ...
            TYPE_EXTRACTED_AAPT2_BINARY = null
    ...
    static String get_TYPE_EXTRACTED_AAPT2_BINARY() {
        try {
            ...
            return TYPE_EXTRACTED_AAPT2_BINARY
        } catch (Exception e) {
            throw new RuntimeException("Cannot access field 'Aapt2MavenUtils.TYPE_EXTRACTED_AAPT2_BINARY'", e)
        }
    }
